...
/**
 * MouseEffects Component — Originkit & GSAP Click FX
 * Supports interactionModes: "rings" | "burst" | "particles" | "crosshair" | "wavy" | "sniper"
 */
export default function MouseEffects({
  ...
  labelColor = "#ffffff",
  labelFont = { fontFamily: "Inter, sans-serif", fontSize: 40, fontWeight: 600 },
  isGlobal = false, // When true, mounts as a fixed full-screen non-blocking overlay
}) {
