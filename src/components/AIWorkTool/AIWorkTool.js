    ...
    <div className="bw" id="everyday-tools">
      <div className="bw-i">
        ...
        <div style={{
          ...
          border: '1px solid rgba(226, 215, 195, 0.18)',
          borderRadius: '9999px',
          ...
          <a
            ...
            style={{
              ...
              gap: '6px',
              padding: '7px 16px',
              background: 'linear-gradient(135deg, #C1552C 0%, #E28B5C 100%)',
              color: '#FFFFFF',
              borderRadius: '9999px',
              fontSize: '13px',
              fontWeight: '700',
              textDecoration: 'none',
              boxShadow: '0 3px 12px rgba(193, 85, 44, 0.35)',
              transition: 'transform 0.2s ease'
            }}
          >
            <span>🎯</span>
            <span>{isHi ? 'AI प्रैक्टिकल क्लासवर्क (18 अभ्यास)' : 'AI Practical Classwork (18 Labs)'}</span>
            <span style={{ fontSize: '10px', background: '#FFFFFF', color: '#C1552C', padding: '1px 6px', borderRadius: '8px', fontWeight: 'bold' }}>NEW</span>
          </a>
          ...
          <a
            ...
            style={{
              ...
              color: '#FBF8F3',
              border: '1px solid rgba(226, 215, 195, 0.15)',
              borderRadius: '9999px',
              fontSize: '13px',
              fontWeight: '600',
              textDecoration: 'none'
          ...
          >
            <span>⌨️</span>
            <span>{isHi ? 'AI स्लैश कमांड्स' : 'AI Slash Commands'}</span>
          </a>
          ...
          >
            <span>🏛️</span>
            <span>{isHi ? 'विभागीय प्रॉम्ट्स' : 'Dept Prompts'}</span>
          </a>
        </div>
